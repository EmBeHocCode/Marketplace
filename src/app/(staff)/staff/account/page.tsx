...
export default async function StaffAccountRoute() {
  const user = await getCurrentSessionUser();

  if (!user) {
    return (
      <EmptyState
        title="Không tải được tài khoản nhân viên"
  ...
  return (
    <div className="space-y-6">
      ...
      <AccountSettingsForm
        ...
        description="Cập nhật avatar, họ tên và số điện thoại để nhân viên hiển thị đúng trong dashboard vận hành."
      />
    </div>
  );
}
